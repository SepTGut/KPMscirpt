...
<template>
  <section>
    ...
    >
      <div class="bg-white dark:bg-slate-900 rounded-3xl max-w-sm w-full p-6 shadow-2xl border border-slate-100 dark:border-slate-800 text-center relative overflow-hidden">
        ...
        <div v-if="isConfirmed" class="py-6 animate-fadeIn">
          <div class="w-16 h-16 mx-auto rounded-full bg-emerald-100 dark:bg-emerald-950/40 border-2 border-emerald-500 text-emerald-600 dark:text-emerald-400 flex items-center justify-center mb-3">
        ...
        <div v-else>
          <div class="flex items-center justify-between pb-3 mb-3 border-b border-slate-100 dark:border-slate-800">
            ...
            <button
              type="button"
              class="w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 flex items-center justify-center text-xs font-bold transition focus-visible:outline-none"
              @click="closeQrModal"
          ...
          <div class="space-y-2">
            <button
              type="button"
              class="w-full min-h-[44px] py-2.5 px-3 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs font-bold flex items-center justify-center gap-2 transition focus-visible:outline-none"
            ...
            <button
              type="button"
              class="w-full py-2 text-center text-xs font-bold text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300 transition"
              @click="closeQrModal"
            >
              Tutup Jendela
            </button>
    ...
    >
      <div class="bg-white dark:bg-slate-900 rounded-3xl max-w-sm w-full p-6 shadow-2xl border border-slate-100 dark:border-slate-800 text-center relative overflow-hidden">
        ...
        <div v-else>
          ...
          <div class="w-16 h-16 mx-auto my-3 rounded-2xl bg-google-blue-50 dark:bg-blue-950/50 border border-google-blue-200 dark:border-blue-800/60 text-google-blue-600 dark:text-blue-400 flex items-center justify-center">
